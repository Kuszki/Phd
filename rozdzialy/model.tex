...
\textbf{Przypadek}   & \textbf{a) $U_{i} \in \interval{1}{3}$} & \textbf{b) $U_{i} \in \interval{1}{6}$} & \textbf{c) $U_{i} \in \interval{1}{10}$} & \textbf{d) $U_{i} \in \interval{1}{20}$} \\ \hline
