...
\begin{gather}
A_{i,s} = \sum _{j = 0} ^{N-1} a_{i, j} = K_{i} \emb{0} \label{eq:alg_trans_stat}, \\
A_{i,r} = \sqrt{\sum _{j = 0} ^{N-1} a_{i, j}^{2}} = \sqrt{\frac{2}{\omega_{p}} \int _{0} ^{\frac{1}{2}\omega_{p}} K_{i}^{2} \emb{\omega} d\omega} \label{eq:alg_trans_rand},
\end{gather}
