...
\begin{gather}
e_{u,sw} \left( t \right) = 0 \label{eq:mid_cont_err_stat_self}, \\
e_{u,sp} \left( t \right) = E_{s,s} \left( 0 \right) \label{eq:mid_cont_err_stat_prop},
\end{gather}
...
\begin{equation}
K_{u} \left( \omega \right) = \left| G_{u} \left( j\omega \right) \right| =
	\sqrt{\left( \Re \left( G_{u} \left( j\omega \right) \right) \right)^{2} +
	\left( \Im \left( G_{u} \left( j\omega \right) \right) \right)^{2}}
...
\begin{equation}
\varphi_{u} \left( \omega \right) = \arctan \left( \frac{\Im \left( G_{u} \left( j\omega \right) \right)}{\Re \left( G_{u} \left( j\omega \right) \right)} \right) \label{eq:mid_cont_phi}.
\end{equation}
...
\begin{equation}
\dot{u} \left( t,\omega \right) = \dot{K}_{u} \left( \omega \right) E_{s,o} \left( \omega \right) \sin \left( \omega t + \varphi_{s,o} \left( \omega \right) + \dot{\varphi}_{u} \left( \omega \right) \right) \label{eq:mid_cont_omega_ideal},
\end{equation}
...
\begin{equation}
e_{u,dp} \left( t \right) = \sum _{i = 1} ^{\infty} \tilde{K}_{u} \left( \omega_{s,i} \right) E_{s,e} \left( \omega_{s,i} \right) \sin \left( \omega_{s,i} t + \varphi_{s,e} \left( \omega_{s,i} \right) + \tilde{\varphi}_{u} \left( \omega_{s,i} \right) \right) \label{eq:mid_cont_err_dyn_prop},
\end{equation}
...
\begin{equation}
\sigma_{u,rp}^{2} = \frac{1}{a - b} \int _{b} ^{a} \tilde{K}_{u}^{2} \left( \omega \right) \sigma_{s,r}^{2} d\omega \label{eq:mid_cont_var_rand},
\end{equation}
...
\begin{equation}
f_{AC} \left( x \right) = n_{q} \left( x \right) = \left\lfloor \frac{x}{q} + 0.5 \right\rfloor \label{eq:adc_function},
\end{equation}
...
\begin{equation}
\breve{u}_{AC} \left( x \right) = q f_{AC} \left( x \right) = q \left\lfloor \frac{x}{q} + 0.5 \right\rfloor \label{eq:adc_output},
\end{equation}
błąd kwantowania $e_{AC,q}$ opisać można równaniem w postaci \cite{jakubiec_system}:
\begin{equation}
e_{AC,q} \left( x \right) = x - \breve{u}_{AC} \left( x \right) = x - q \left\lfloor \frac{x}{q} + 0.5 \right\rfloor \label{eq:adc_qerror},
\end{equation}
...
\begin{equation}
-\frac{q}{2} \le e_{AC,q} \left( x \right) \le \frac{q}{2} \label{eq:adc_qerrrange}.
\end{equation}
...
\begin{equation}
\dot{x} \left( i \right) = \sum _{j = 0} ^{\infty} \dot{x} \left( i, \omega_{x,j} \right) \label{eq:in_disc_sum},
\end{equation}
...
\begin{gather}
\dot{x} \left( i, \omega \right) = E_{x,o} \left( \omega \right) \sin \left( \omega iT_{p} + \varphi_{s,o} \left( \omega \right) \right) \label{eq:in_disc_omega_ideal}, \\
\tilde{x} \left( i, \omega \right) = \dot{x} \left( i, \omega \right) + E_{x,e} \left( \omega \right) \sin \left( \omega iT_{p} + \varphi_{x,e} \left( \omega \right) \right) \label{eq:in_disc_omega_real}, \\
\tilde{x} \left( i \right) = e_{x,r} \left( i \right) + \sum _{j = 0} ^{\infty} \tilde{x} \left( i, \omega_{x,j} \right) \label{eq:in_disc_sum_real},
\end{gather}
...
\begin{equation}
\tilde{x} \left( i \right) = \dot{x} \left( i \right) + e_{x,s} \left( i \right) + e_{x,d} \left( i \right) + e_{x,r} \left( i \right) \label{eq:in_disc_real},
\end{equation}
...
\begin{gather}
e_{x,s} \left( i \right) = E_{x,e} \left( \omega_{s,0} \right) \sin \left( \omega_{s,0} iT_{p} + \varphi_{x,e} \left( \omega_{x,0} \right) \right) = E_{x,e} \left( 0 \right) \label{eq:in_disc_err_stat}, \\
e_{x,d} \left( i \right) = \sum _{i = 1} ^{\infty} E_{x,e} \left( \omega_{x,i} \right) \sin \left( \omega_{x,i} iT_{p} + \varphi_{x,e} \left( \omega_{x,i} \right) \right) \label{eq:in_disc_err_dyn}.
\end{gather}
...
\begin{equation}
e_{x,\Sigma} \left( i \right) = e_{x,s} \left( i \right) + e_{x,d} \left( i \right) + e_{x,r} \left( i \right) \label{eq:in_disc_err_sum}.
\end{equation}
