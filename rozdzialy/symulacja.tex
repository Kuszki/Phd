...
\end{gather}
Oznaczając symbolem $\mathbfit{U}_{T_{1,0}}$ wektor niepewności cząstkowych oraz symbolem  $\mathbfit{h}_{S_{2,0}}$ macierz koherencji związane z analizowaną wielkością $T_{1,0}$, wartość wypadkowej niepewności rozszerzonej tej wielkości wyznaczyć można zgodnie z równaniem~\eqref{eq:unc_matrix}:
\begin{gather}
