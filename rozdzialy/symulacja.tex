...
\begin{equation}
\sigma_{S_{2,0},\Sigma}^{2} = \sigma_{S_{2,0},z}^{2} + \sigma_{S_{2,0},s}^{2} + \sigma_{S_{2,0},r}^{2} + \sigma_{S_{2,0},d,1}^{2} + \sigma_{S_{2,0},d,2}^{2} + \sigma_{S_{2,0},d,3}^{2} = \qty{1.47}{mV} \label{eqn_sym_partd_output_var_sum_S_2_0},
\end{equation}
...
\begin{gather}
U_{S_{2,0},z} = c_{S_{2,0},z} \sigma_{S_{2,0},z} = \qty{2.13}{mV} \label{eqn_sym_partd_output_unc_roun_S_2_0},\\
U_{S_{2,0},s} = c_{t} \sigma_{S_{2,0},s} = \qty{39.31}{mV} \label{eqn_sym_partd_output_unc_stat_S_2_0}, \\
U_{S_{2,0},r} = c_{n} \sigma_{S_{2,0},r} = \qty{24.38}{mV} \label{eqn_sym_partd_output_unc_rand_S_2_0}, \\
U_{S_{2,0},d,1} = c_{d} \sigma_{S_{2,0},d,1} = \qty{18.31}{mV} \label{eqn_sym_partd_output_unc_dyn_1_S_2_0}, \\
U_{S_{2,0},d,2} = c_{d} \sigma_{S_{2,0},d,2} = \qty{37.51}{mV} \label{eqn_sym_partd_output_unc_dyn_2_S_2_0}, \\
U_{S_{2,0},d,3} = c_{d} \sigma_{S_{2,0},d,3} = \qty{3.45}{mV} \label{eqn_sym_partd_output_unc_dyn_3_S_2_0}.
\end{gather}
...
Analogicznie jak w w przypadku przedstawionych powyżej rozważań, parametry wariancji sygnałów błędów propagowanych dla wielkości wyjściowej $T_{1,0}$ wyznaczyć można jako:
\begin{gather}
...
\sigma_{T_{1,0},d,1}^{2} = \sigma_{c,d,1}^{2} K_{T_{1,0}}^{2} \left( \omega_{c,e,1} \right) = {1.99}^{2} \cdot \num{42.6e-6} = \qty{168.70}{\micro V} \label{eqn_sym_partd_output_var_dyn_1_T_1_0}, \\
\sigma_{T_{1,0},d,2}^{2} = \sigma_{c,d,2}^{2} K_{T_{1,0}}^{2}\left(\omega_{c,e,2}\right) = {1.63}^{2} \cdot \num{266.34e-6} = \qty{707.64}{\micro V} \label{eqn_sym_partd_output_var_dyn_2_T_1_0}, \\
\sigma_{T_{1,0},d,3}^{2} = \sigma_{c,d,3}^{2} K_{T_{1,0}}^{2} \left( \omega_{c,e,3} \right) = {0.15}^{2} \cdot \num{266.11e-6} = \qty{5.99}{\micro V} \label{eqn_sym_partd_output_var_dyn_3_T_1_0},
\end{gather}
natomiast zgodnie z tabelą \ref{tab_varnum_db2_2_f16}, wariancja błędu własnego zaokrągleń $\sigma_{T_{1,0},z}^{2}$ wynosi w tym przypadku \qty{0.699}{\micro V}. Wobec powyższych, zgodnie z równaniem \eqref{eqn_var_sum}, wariancję błędu wypadkowego wielkości wyjściowej $T_{1,0}$ opisuje zależność:
\begin{equation}
\sigma_{T_{1,0},\Sigma}^{2} = \sigma_{T_{1,0},z}^{2} + \sigma_{T_{1,0},s}^{2} + \sigma_{T_{1,0},r}^{2} + \sigma_{T_{1,0},d,1}^{2} + \sigma_{T_{1,0},d,2}^{2} + \sigma_{T_{1,0},d,3}^{2} = \qty{1.47}{mV} \label{eqn_sym_partd_output_var_sum_T_1_0},
\end{equation}
