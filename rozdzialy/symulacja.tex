...
\begin{equation}
\sigma^{2} = f(\sigma)^{2} \label{eqn_var_function},
\end{equation}
przy czym zauważyć należy, że kształt rozkładu przetwarzanej wielkości nie ulega zmianie. Wyznaczone parametry wypadkowe sygnału błędu dynamicznego $e_{b,d}$ zestawiono w tabeli TODO, natomiast tabela TDOD przedstawia budżet niepewności wielkości wyjściowej analizowanego wzmacniacza pomiarowego.
