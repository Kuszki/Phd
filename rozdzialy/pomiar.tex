...
& \sum _{j = 1} ^{\infty} E_{s,o} \emb{\omega_{x,j}} \sin \left( \omega_{s,j} iT_{p} + \varphi_{s,o} \emb{\omega_{s,j}} + \dot{\varphi}_{s,x} \emb{\omega_{s,j}} \right)
\end{split}
...
\end{equation}
gdzie podane równanie jest odpowiednie dla zakresu częstotliwości $\hat{f} \in \interval[scaled]{0}{\frac{1}{2} f_{p}}$.
