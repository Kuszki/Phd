...
\begin{table}[htb!]
\begin{center}
\makecaption{tab:unc_coherdwt}{Wartości współczynników kształtu dla typowych kształtów rozkładów oraz rozkładu błędu zaokrągleń algorytmu transformacji falkowej}
\begin{tabular}[c]{| c | c | c | c | c |} \hline
$s_{r,*}$ & $n$ & $u$ & $t$ & $d$ \\ \hline
$r$ & $0.123$ & $0.123$ & $0.123$ & $0.123$ \\ \hline
\end{tabular}
\end{center}
\end{table}
