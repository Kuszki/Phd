...
\begin{equation}
w_{m,n} = \frac{1}{\sqrt{2^m}} \int _{-\infty} ^{\infty} { x(t) \psi \left( \frac{t-2n^m}{2^m} \right) } dt \label{eqn_dwt}.
\end{equation}
...
\begin{equation}
\phi_{m,n}(t) = \frac{1}{\sqrt{2^m}} \phi \left( \frac{t-2n^m}{2^m} \right) dt \label{eqn_dwt_scalefun},
\end{equation}
...
\begin{equation}
\int _{-\infty} ^{\infty} \phi_{0,0}(t) dt = 1 \label{eqn_dwt_fatherwav},
\end{equation}
