...
#f = 5;    w = 31.413179515689;
#f = 100;  w = 628.299970479762;
#f = 200;  w = 1256.59845943;
f = 1000; w = 6282.99493480;
#f = 10000; w = 62829.9224255;
...
fa(x) = ADC(sin(x*ts*w) * ((0.98*950-2) / 2.0) + (0.98*500-2))
fb(x) = ADC(sin(x*ts*w) * ((0.98*950-2) / 2.0) + (1.02*500+2))
fc(x) = ADC(sin(x*ts*w) * ((1.02*950+2) / 2.0) + (0.98*500-2))
fd(x) = ADC(sin(x*ts*w) * ((1.02*950+2) / 2.0) + (1.02*500+2))
