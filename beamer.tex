...
\begin{itemize}
\item $e_{x,rw}(i)$ -- losowy własny, związany ze zidentyfikowanymi właściwościami statycznymi
\item $e_{x,dw}(i)$ -- dynamiczny własny, związany z właściwościami dynamicznymi
\item $e_{x,dp}(i)$ -- dynamiczny propagowany, związany z sygnałem błędu zawartym w $s(t)$
\item $e_{x,sp}(i)$ -- statyczny propagowany, związany z sygnałem błędu zawartym w $s(t)$
\item $e_{x,rp}(i)$ -- losowy propagowany, związany z sygnałem szumu wielkości $s(t)$
\end{itemize}
\begin{itemize}
